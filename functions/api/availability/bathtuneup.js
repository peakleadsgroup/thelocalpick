/**
 * Bath Tune Up — GHL calendar availability (JSON for landing pages).
 *
 * URL: https://YOUR_DOMAIN/api/availability/bathtuneup
...
const PARTNER_SLUG = 'bathtuneup';
const CALENDAR_ID = 'k6bokOz0oIicKYu93zhW';
const DEFAULT_TIMEZONE = 'America/New_York';

/** @param {{ BathTuneUpGHLAPI?: string }} env */
function getApiToken(env) {
  return env.BathTuneUpGHLAPI;
}
